        ...
        if (interaction.isCommand && interaction.isCommand()) {
            ...
            const createSlashCommandPages = () => {
                ...
                pages.push({
                    ...
                    image: "https://cdn.discordapp.com/avatars/1052983625425100812/c92821f5755e741b4e0c993eebcfbcbf.webp?size=1024",
                    color: "#3498db",
                ...
                for (const [category, commands] of Object.entries(commandData)) {
                    ...
                    switch (category) {
                        case 'anime':
                            page.image = "https://cdn.discordapp.com/attachments/1248655075702870109/1314495633696100422/standard_4.gif?ex=6753faf5&is=6752a975&hm=73b8f5a32807d27608ff2fde49776c99430f3ada69a358cbf3a4abdae89fe06b&";
                            page.color = "#ff66cc";
                            page.thumbnail = "https://cdn.discordapp.com/avatars/1052983625425100812/c92821f5755e741b4e0c993eebcfbcbf.png?size=256";
            ...
            const createPrefixCommandPages = () => {
                ...
                pages.push({
                    ...
                    description: `Welcome to the help command! This bot provides a variety of commands to enhance your server experience. Below are the categories and the number of commands available in each.`,
                    commands: [
                        `**💜 Bot Developer:** BrandMineGamer07\n`+
                        `**Bot Version:** 1.1.0\n`+
                        `**Total Servers:** ${totalServers}\n`+
                        `**Total Members:** ${totalMembers}\n`+
                        `**Bot Uptime:** ${uptimeHours}h ${uptimeMinutes}m ${uptimeSeconds}s\n`+
